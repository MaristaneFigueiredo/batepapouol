...
//   console.log('lista', lista);
 ...
 function inserirDadosBatePapo(usuario){
    ...
    try {
      ...
      const promessa =  axios.post('https://mock-api.driven.com.br/api/v6/uol/participants ', {name: sessionStorage.getItem('user')})
      console.log(' antes promessa', promessa)  
      promessa.then(buscarDadosBatePapo); //Agenda para tratar o sucesso, ou seja, trazer os dados
      console.log(' depois promessa', promessa)  
      ...
      //promessa.catch( (erro) => console.log('erroooo =', erro))
    } catch (error) {
